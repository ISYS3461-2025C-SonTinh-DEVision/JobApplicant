...
/**
 * DTO for applicant list item (used in search/list endpoints)
 * Excludes userId for privacy/security reasons
 */
public class ApplicantListItemResponse {
    ...
    public ApplicantListItemResponse() {}

    public ApplicantListItemResponse(String id, String firstName, String lastName,
